...
def test(driver):
    ...
    time.sleep(3)
    driver.find_element(By.NAME, 'firstName').send_keys('Aureli')
    ...
    driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/form/div[1]/div[2]/div[4]/div/div[1]/div/div[2]/input').send_keys('Aurelis123')
    driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/form/div[1]/div[2]/div[4]/div/div[2]/div/div[2]/input').send_keys('Aurelis123')
    time.sleep(3)
